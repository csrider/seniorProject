	...
	<table width="750" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td width="100%" align="center" class="section_title">Z-MEN Equipment<br /><br /></td>
				</tr>
				<tr>
					<td width="100%" align="center" class="section_text">
						At Z-MEN we have an extensive line of equipment used to make your lawn look great. 
						Each year we invest in new equipment that will help us get the job done right. 
						The following is our current line-up of equipment:
					</td>
				</tr>
			</table>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td colspan="3" height="20"><!--SPACER--></td>
				</tr>
				<tr>
					<td width="33%" align="center"><img src="images/gravely.gif" /></td>
					<td width="34%" align="center"><img src="images/JD445.gif" /></td>
					<td width="33%" align="center"><img src="images/JD185.jpg" /></td>
				</tr>
				<tr style="font-weight:bold ">
					<td width="33%" align="center">Gravely 260Z Zero-Turn</td>
					<td width="34%" align="center">John Deere 445</td>
					<td width="33%" align="center">2 John Deere 185</td>
				</tr>
			</table>
			
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td colspan="5" height="20"><!--SPACER--></td>
				</tr>
				<tr style="font-weight:bold ">
					<td width="10%"><!--LEFT SPACER--></td>
					<td width="40%" align="left" valign="top">
						&bull;&nbsp; Murray Bagging Mower<br />
						&bull;&nbsp; 6 Stihl Trimmers<br />
						&bull;&nbsp; 2 Stihl Hand-Held Blowers<br />
						&bull;&nbsp; 3 Trailers
					</td>
					<td width="5%"><!--MIDDLE SPACER--></td>
					<td width="35%" align="left" valign="top">
						&bull;&nbsp; Numerous Push Mowers<br />
						&bull;&nbsp; 2 Stihl Backpack Blowers<br />
						&bull;&nbsp; Stihl Edger
					</td>
					<td width="10%"><!--RIGHT SPACER--></td>
				</tr>
				<tr>
					<td colspan="5" height="20"><!--SPACER--></td>
				</tr>
				<tr>
					<td align="center" colspan="5" class="section_title">Access to other equipment includes:<br /><br /></td>
				</tr>
				<tr style="font-weight:bold ">
					<td width="10%"><!--LEFT SPACER--></td>
					<td width="40%" align="left" valign="top">
						&bull;&nbsp; Lawn Sweepers<br />
						&bull;&nbsp; Chain Saws
					</td>
					<td width="5%"><!--MIDDLE SPACER--></td>
					<td width="35%" align="left" valign="top">
						&bull;&nbsp; Thatcherizers<br />
						&bull;&nbsp; Snow Blowers
					</td>
					<td width="10%"><!--RIGHT SPACER--></td>
				</tr>
