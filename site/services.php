...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	<tr>
		<td colspan="2" align="center" class="section_title">Z-Men Services</td>
	</tr>
	<tr>
		<td colspan="2" align="left" class="style9"><strong>BASIC PACKAGE</strong> - Z-Men offers a basic lawn care package which includes:</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2" align="left" class="style9"><strong>ADDITONAL OPTIONS</strong> - Other services are offered by Z-Men and can be added to the basic package or purchased separately. These services include:</td>
	</tr>
  <tr>
    <td valign="top" align="left" width="50%" class="style8">
    	<ul>
      	<li>Grass Clipping Removal</li>
        <li>Sidewalk Edging</li>
				<li>Overgrown Property Mowing </li>
				<li>Seeding</li>
				<li>Pesticides</li>
				<li>Tree Trimming </li>
		...
		<td valign="top" align="left" width="50%" class="style8">
			<ul>
				<li>Leaf Removal</li>
				<li>Snow Removal</li>
				<li>Ditchbank Mowing </li>
				<li>Fertilizing</li>
				<li>Gutter Cleaning </li>
				<li>Shrub Prunning </li>
	...
	<tr>
		<td colspan="2" class="style8">
			...
			Any combination of sevices can be provided, <a href="contact_us.php">call or email us</a> today for your free estimate! You may also <a href="prices.php">sign-up online</a>, for your free consultation!
		</td>
	</tr>
</table>
