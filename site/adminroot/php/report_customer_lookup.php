...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td valign="top" align="left">			
			...
			<form action="report_customer_find.php" method="post" name="find_cust" target="blank">
			<table border="1"><tr><td>
			 
			 <table>
				<tr><td align="center" colspan="2" bgcolor="#CCCCCC"><h3>Search for Customer to generate Report</h3></td></tr>
				<tr>
					<td align="right">Find by Home Phone</td>
					<td align="left"><input type="text" name="find_cust_hphone" maxlength="13" size="14" onfocus="javascript:getIt(this)" /></td>
				</tr>
