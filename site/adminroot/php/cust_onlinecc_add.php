...
if ($_SESSION['admin_user']) {
	...
	if ($_POST['ccv_id'] != 0) {	//value of "0" means they didn't want to store any credit card information
		$query = "INSERT INTO customer_cc (
		          	cust_id,
								custcc_address1,
								custcc_address2,
								custcc_city,
							...
							VALUES (
								'".$_SESSION['cust_id']."',
								'".$_POST['custcc_address1']."',
								'".$_POST['custcc_address2']."',
								'".$_POST['custcc_city']."',
								'".$_POST['custcc_state']."',
								'".$_POST['custcc_zip']."',
								'".$_POST['ccv_id']."',
