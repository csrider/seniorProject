...
<!-- TemplateEndEditable --><!-- TemplateParam name="title_bar_shadow" type="boolean" value="false" --><!-- TemplateParam name="body_topgreen" type="boolean" value="true" --><!-- TemplateParam name="body_bottomgreen" type="boolean" value="true" -->
</head>
		...
		<tr><td width="750">
			...
			<table width="750" cellpadding="0" cellspacing="0">
			  ...
			  <!--The following code will display the shadow if the page is setup to display it in the <HEAD> section-->
				<!-- TemplateBeginIf cond="_document['title_bar_shadow']" -->
        <tr>
		...
		<tr>
			<td width="750" valign="top" align="left">
				...
				<table width="100%" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0">
					<!-- TemplateBeginIf cond="body_topgreen" -->
					<tr>
					...
					<tr>
						...
						<td width="600" height="350" align="left" valign="top" class="main_body_cell">
							...
							<p>Make this table into WHATEVER is needed to make it look right! Feel free to change width, rows, columns, etc... but it might be a good idea to leave the cellpadding & cellspacing alone.</p>
							<p>You are free to change the background color (bgcolor attribute) of the &lt;table&gt; or &lt;td&gt; tags (instead of having the same background color as the page), cell alignment, or anything else you want... go crazy!</p>
							<br />
					...
					<!-- TemplateBeginIf cond="body_bottomgreen" -->
					<tr>
						<td colspan="3" bgcolor="#5CA758" background="../images/1x1_green.gif">&nbsp;</td>
					</tr>
					<!-- TemplateEndIf -->
