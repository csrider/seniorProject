...
<script language="javascript" type="text/javascript">
	function goto_benefits() {
		window.name = "index";
		window.open('/zmen/benefits.htm','','menubar=no,toolbar=no,status=no,width=350,height=300,resizable=yes,scrollbars=no');
	}
</script>
<!-- InstanceEndEditable --><!-- InstanceParam name="title_bar_shadow" type="boolean" value="true" --><!-- InstanceParam name="body_topgreen" type="boolean" value="false" --><!-- InstanceParam name="body_bottomgreen" type="boolean" value="false" -->
</head>
...
<td align="left" valign="top">
	...
	<table width="750" cellpadding="0" cellspacing="0">
        ...
        <tr>
        	<td height="14" width="750" colspan="13"><img height="14" width="750" src="images/shadow.gif" /></td>
        </tr>
		...
		<tr>
			...
			//Background Color (content area)
				$bgcolor = '#cccccc';
			?>
			<table width="750" height="350" cellpadding="0" cellspacing="0" border="0">
				<tr>
					
					<!--cell that holds the weather formatting-->
					<td width="245" height="450" valign="top">
						<div align="center">
							<script language="JavaScript" type="text/javascript" >
								//var loc = '47715';
								//var param = "id", "netWeather", "minversion", "6,0,0,0", "movie", "http://netWeather.accuweather.com/adcbin/netWeather/netWxCheck?v=netWxA3&z=47715&tc=0x0&ttc=0xffff00&tbc=0x5ca758&bc=0xf3efec&t=Z%2DMen%20Weather", "quality", "high", "src", "http://netWeather.accuweather.com/adcbin/netWeather/netWxCheck?v=netWxA3&z=47715&tc=0x0&ttc=0xffff00&tbc=0x5ca758&bc=0xf3efec&t=Z%2DMen%20Weather", "width", "245", "height", "450", "name", "netWeather", "align", "top";
								//RunNetWeather (param)
								RunNetWeather ("id", "netWeather", "minversion", "6,0,0,0", "movie", "http://netWeather.accuweather.com/adcbin/netWeather/netWxCheck?v=netWxA3&z=47715&tc=0x0&ttc=0xffff00&tbc=0x5ca758&bc=0xf3efec&t=Z%2DMEN%20Weather", "quality", "high", "src", "http://netWeather.accuweather.com/adcbin/netWeather/netWxCheck?v=netWxA3&z=47715&tc=0x0&ttc=0xffff00&tbc=0x5ca758&bc=0xf3efec&t=Z%2DMEN%20Weather", "width", "245", "height", "450", "name", "netWeather", "align", "top")
							</script>
						</div>
					</td>
					
					<!--cell that holds the main section formatting-->
					<td width="505" height="450" valign="top">
						
						<!--table that formats the main section-->
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="505" height="100%" valign="top">
									
									<!--table that holds login/tips area-->
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td height="101" width="11" valign="top" bgcolor="<?php echo $bgcolor; ?>"></td>
											<td height="101" width="484" valign="top" bgcolor="<?php echo $bgcolor; ?>">
											<?php
											if (!isset($_SESSION['user_online_record'])) {		//if not logged-in, then display login area, else don't display
												echo '
												<!--table that contains and formats the registered user login & new user area-->
												<table width="100%" height="101" cellpadding="0" cellspacing="0" border="0" bgcolor="#5CA758">
													<tr>
														<td height="18" width="100%" colspan="5" align="center" bgcolor="#000000" style="color:#FFFFFF; font-weight:bold; font-family:\'Lucida Console\', Verdana, Arial, \'Courier New\'; font-size:16px">
															Registered User?&nbsp;&nbsp;Sign In Here
														</td>
													</tr>
													<tr>
														<form method="post" action="php/login.php" name="login_form">
														<td align="right" style="font-weight:bold; font-family:\'Lucida Console\', Verdana, Arial, \'Courier New\'; font-size:13px ">&nbsp;Username:</td>
														<td align="left"><input type="text" name="custo_username" maxlength="16" size="16" /></td>
														<td align="right" style="font-weight:bold; font-family:\'Lucida Console\', Verdana, Arial, \'Courier New\'; font-size:13px ">&nbsp;Password:</td>
														<td align="left"><input type="password" name="custo_password" maxlength="16" size="16" /></td>
														<td align="center"><input type="submit" value="Log-in" />&nbsp;</td>
														</form>
													</tr>
													<tr>
														<td height="14" width="100%" colspan="5" align="center" style="font-family:\'Lucida Console\', Verdana, Arial, \'Courier New\'; font-size:12px ">
															<a href="javascript:goto_benefits()" class="pagelink_plain">New User? Click here to see the benefits of being a Z-MEN customer!</a>
														</td>
													</tr>
												</table>
												';//end echo
												...
												echo'
												<!--table that displays the random tip instead of the login screen, for those who are logged-in-->
												<table width="100%" height="101" cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td height="99" width="482" valign="middle" align="center" bgcolor="#5ca758">
															<span class="tip_title">Z-MEN Lawn Care Tip:</span>
															<br />
															<span class="tip_text">';		echo get_random_tip('auto');		echo'</span>
														</td>
													</tr>
												</table>
												';//end echo
											...
											<td height="101" width="10" valign="top" bgcolor="<?php echo $bgcolor; ?>"></td>
										</tr>
									</table>
									<!--END login/tips table-->
									
								</td>
							</tr>
							<tr><td height="11" bgcolor="<?php echo $bgcolor; ?>"></td></tr>
							<tr>
							 <td>
							 	
								<!--main area below the login/tips area-->
								<table border="0" cellpadding="0" cellspacing="0">
							 		<tr>
										<td height="181" width="11" valign="top" bgcolor="<?php echo $bgcolor; ?>"></td>
							  		<td width="484" height="181" align="center" valign="middle" background="images/bg_main1.jpg" class="tip_text">
											<?php
											//Logged-in Customer Information that may get displayed
											if(isset($_SESSION['user_online_record'])) {
												$customer_online = $_SESSION['user_online_record'];								//extract customer_online record from session
												$customer = load_customer($customer_online['cust_id']);						//load customer record from fns_queries.php
												$customer_bank = load_customer_bank($customer_online['cust_id']);	//load customer_bank record
												$customer_cc = load_customer_cc($customer_online['cust_id']);			//load customer_cc record
												echo'
													<table border="1" bgcolor="#5CA758" cellspacing="0" cellpadding="3">
														<tr>
															<td align="center">
																<a href="php/customer_invoice.php" target="_blank" class="logged_in_menu">&nbsp;Invoice / Summary&nbsp;</a>
															</td>
														</tr>
														<tr>
															<td align="center">
																<a href="php/pay_invoice.php" class="logged_in_menu">&nbsp;Make Payment&nbsp;</a>
															</td>
														</tr>
														<tr>
															<td align="center">
																<a href="php/customer_edit_form.php" class="logged_in_menu">&nbsp;Personal Information&nbsp;</a>
															</td>
														</tr>';
													if(isset($customer_bank['cust_id'])) { echo'
														<tr>
															<td align="center">
																<a href="php/customer_bank_edit_form.php" class="logged_in_menu">&nbsp;Bank Account&nbsp;</a>
															</td>
														</tr>';}
													else if(isset($customer_cc['cust_id'])) { echo'
														<tr>
															<td align="center">
																<a href="php/customer_cc_edit_form.php" class="logged_in_menu">&nbsp;Credit Card&nbsp;</a>
															</td>
														</tr>';}
													echo'														
														<tr>
															<td align="center">
																<a href="php/customer_online_edit_form.php" class="logged_in_menu">&nbsp;Online Settings&nbsp;</a>
															</td>
														</tr>
													</table>
												';//end echo
										...
										<td height="181" width="10" valign="top" bgcolor="<?php echo $bgcolor; ?>"></td>
									</tr>
									<tr>
										<td height="96" width="11" valign="top" bgcolor="<?php echo $bgcolor; ?>"></td>
										<td height="96" width="484"><img src="images/bg_main2.jpg" height="96" width="484" /></td>
										<td height="96" width="10" valign="top" bgcolor="<?php echo $bgcolor; ?>"></td>
									</tr>
									<tr>
										<td height="21" width="11" valign="top" bgcolor="<?php echo $bgcolor; ?>"></td>
										<td height="21" width="484"><img src="images/bg_main3.gif" height="21" width="484" /></td>
										<td height="21" width="10" valign="top" bgcolor="<?php echo $bgcolor; ?>"></td>
									</tr>
									<tr><td height="40" width="100%" bgcolor="<?php echo $bgcolor; ?>" colspan="3"></td></tr>
								</table>
								<!--END main area below the login/tips area-->
								
							 </td>
							</tr>
						</table>
						<!--END table that formats the main section-->
